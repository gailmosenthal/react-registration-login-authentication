...
const Register = () => {
  ...
  return (
    <>
      ...
      <form onSubmit={handleSignup}>
        ...
        {userFocus&&user&&!validName&&<p id="uidnote" className={'instructions'}>
          <FaInfoCircle />
  ...
  {/* passwd field */}
          <label htmlFor="password">
            Password:
            <span className={validPasswd?'valid':'hide'}><FaCheck/></span>
            <span className={validPasswd||!passwd?'hide':'invalid'}><FaTimes/></span>
          </label>
          <input 
          type="password" 
          id="password" 
          ...
          {passwdFocus&&passwd&&!validPasswd&&<p id="passwdnote" className={'instructions'}>
            <FaInfoCircle />
            8 to 25 characters. <br />
            Must include uppercase and lowercase letters, a number and a special character <br />
            Allowed special characters: <span aria-label="exclamation mark">!</span>, <span aria-label="at symbol">@</span>, <span aria-label="hashtag">#</span>, or <span aria-label="dollar sign">$</span>,<span aria-label="percent">%</span>.
          </p>}
          {/* passwd confirm field */}
          <label htmlFor="confirm_password">
            Confirm password:
            <span className={validMatchPasswd&&matchPasswd?'valid':'hide'}><FaCheck/></span>
            <span className={validMatchPasswd||!matchPasswd?'hide':'invalid'}><FaTimes/></span>
          </label>
          <input 
          type="password" 
          id="confirm_password" 
          ...
          {matchPasswdFocus&&!validMatchPasswd&&<p id="confirmpasswdnote" className={'instructions'}>
            <FaInfoCircle />
